...
`
  ...
  userPrompt += `\nGenerate test cases covering positive scenarios, negative scenarios, edge cases as applicable. Return only the JSON response as valid JSON.
Generate a maximum of 10 concise, actionable test cases.`
